...
class PostInCategory extends WP_Widget
{
	...
	function form($instance)
	{
        ...
        ?>
			...
			<p><?php _e( 'Want more options and support?')?> - <a href="http://codecanyon.net/item/smart-post-lists-widget-for-wordpress/935289?ref=OTWthemes"><?php _e( 'Try the full version.');?></a></p>
			<p>
...
Check out the <a href="http://otwthemes.com/product/sidebar-widget-manager-for-wordpress/?utm_source=wp.org&utm_medium=admin&utm_content=otherp&utm_campaign=spll">Sidebar and Widget Manager</a><br /><br />
