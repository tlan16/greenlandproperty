...
class MapProperties_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
			'MapProperties_Widget',
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'map_filtering' ); ?>"><?php echo __( 'Map filtering', 'aviators' ); ?></label>
